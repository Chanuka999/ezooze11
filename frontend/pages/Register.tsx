...
export const Register: React.FC<RegisterProps> = ({ navigateTo }) => {
  ...
  const inputClasses =
    "appearance-none relative block w-full px-4 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-brand-gold focus:border-brand-gold sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white";
      ...
      <div className="flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-md w-full space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            {error && (
              <p className="text-center text-sm text-red-600 bg-red-100 dark:bg-red-900/20 p-3 rounded-md">
                {error}
              </p>
            )}
