...
export const Login: React.FC<LoginProps> = ({ navigateTo }) => {
  ...
  const inputClasses =
    "appearance-none block w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-brand-gold focus:border-brand-gold sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white";
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 min-h-[calc(100vh-5rem)]">
      <div className="flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-md w-full space-y-8">
          <div>
            <h1
              className="font-serif text-4xl font-bold text-center text-brand-charcoal dark:text-brand-cream cursor-pointer"
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                required
                className={
                  validationErrors.email ? errorInputClasses : inputClasses
                }
            ...
            <div>
              ...
              <input
                ...
                required
                className={
                  validationErrors.password ? errorInputClasses : inputClasses
                }
            ...
            <div className="flex items-center justify-end">
              <div className="text-sm">
                <button
                  ...
                  className="font-medium text-brand-gold hover:text-yellow-600 hover:underline"
                >
